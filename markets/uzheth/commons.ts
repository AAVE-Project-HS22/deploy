...
export const CommonsConfig: ICommonConfiguration = {
  MarketId: "Commons UZHETH Market",
  ATokenNamePrefix: "Uzheth",
  StableDebtTokenNamePrefix: "Uzheth",
  VariableDebtTokenNamePrefix: "Uzheth",
  SymbolPrefix: "Uzheth",
  ProviderId: 8080,
  OracleQuoteCurrencyAddress: ZERO_ADDRESS,
  OracleQuoteCurrency: "USD",
  OracleQuoteUnit: "8",
  WrappedNativeTokenSymbol: "WUZHETH",
  ChainlinkAggregator: {
  ...
  ParaswapRegistry: {
    ...
    [eEthereumNetwork.uzheth]: "0xa68bEA62Dc4034A689AA0F58A76681433caCa663",
  },
  FlashLoanPremiums: {
    total: 0.0005e4,
    protocol: 0.0004e4,
